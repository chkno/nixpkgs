...
final: prev: {
  ...
  enclosed-exceptions = dontCheck prev.enclosed-exceptions;

  # https://github.com/jaor/xmobar/issues/356
  xmobar = prev.xmobar.overrideScope (final: prev: { hinotify = final.hinotify_0_3_9; });
  hinotify_0_3_9 = dontCheck (doJailbreak prev.hinotify_0_3_9); # allow async 2.2.x
  ...
  stack = (doJailbreak prev.stack).override {
    Cabal = final.Cabal_2_4_1_0;
    hpack = final.hpack.override { Cabal = final.Cabal_2_4_1_0; };
    hackage-security = final.hackage-security.override { Cabal = final.Cabal_2_4_1_0; };
  };

  # Older GHC versions need these additional dependencies.
  aeson = addBuildDepend prev.aeson final.contravariant;
  ...
  fast-logger = dontHaddock prev.fast-logger;
