...
final: prev: {
  ...
  dconf2nix = final.callPackage ../tools/haskell/dconf2nix/dconf2nix.nix { };

  # https://github.com/channable/vaultenv/issues/1
  vaultenv = final.callPackage ../tools/haskell/vaultenv { };

  # spago is not released to Hackage.
  # https://github.com/spacchetti/spago/issues/512
  spago = final.callPackage ../tools/purescript/spago/spago.nix { };
  ...
  haskell-language-server = final.callPackage ../tools/haskell/haskell-language-server { };
  hls-ghcide = final.callPackage ../tools/haskell/haskell-language-server/hls-ghcide.nix { };
}
